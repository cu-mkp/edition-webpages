...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| Blue and superscript   | Ms. author additions                                                                                                                                                                                                                                                                                    | IMAGE       |
| Red and struck-through | Ms. author deletions                                                                                                                                                                                                                                                                                    | IMAGE       |
| Grey highlight         | Text is under the paper strips used in the rebinding                                                                                                                                                                                                                                                    | IMAGE       |
| Italics                | Foreign language that has been left in the original,                                                                                                                                                                                                                                                    | IMAGE       |
| Bold (emphasis)        | Italic script in the original                                                                                                                                                                                                                                                                           | IMAGE       |
| \[*illegible*\]        | Illegible word that could not be fully transcribed/translated                                                                                                                                                                                                                                           | IMAGE       |
| \[*gap*\]              | Space left in the original                                                                                                                                                                                                                                                                              | IMAGE       |
| Curly brackets         | Expansions: providing the expanded version of the text implied by the author-practitioner’s abbreviation marks                                                                                                                                                                                          | IMAGE       |
| Square brackets        | Editorial supplies: indicating editorial interventions and corrections. For example, deletions of duplicate words, addition of missing words, addition of expanded text when abbreviation marks are missing, supplied titles for entries with no heading (visible in List of Entries entries list only) | IMAGE       |
| Horizontal lines       | Approximate pen marks in the original used to separate text blocks from one another                                                                                                                                                                                                                     | IMAGE       |
| “*Continued…*”         | Indicating continuation on the following page                                                                                                                                                                                                                                                           | IMAGE       |
| “*...Continued*”       | Indicating continuation from the previous page                                                                                                                                                                                                                                                          | IMAGE       |
| Essay Icon             | Research Essays (see below)                                                                                                                                                                                                                                                                             | IMAGE       |
| Red asterisks          | Editorial Comments (see below)                                                                                                                                                                                                                                                                          | IMAGE       |
...
Diana Mellon, “Excellent Mustard,” in *Secrets of Craft and Nature in
Renaissance France. A Digital Critical Edition and English Translation
of BnF Ms. Fr. 640*, <http://edition640.makingandknowing.org>, eds. The
...
The XML files used as the source for the edition along with other
metadata may be found in the Github repository
