...
For the reference sources used in translation, see our list of [Dictionaries and Technical Encyclopedias](/content/resources/principles#linguistic-resources-dictionaries-and-technical-encyclopedias).
...
|-------------|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| add         | addition          | an addition made to the text by the writer in the original; renders in blue font of a smaller size. Passages were judged to be "additions" by: superscript in main body, significant changes in ink color, squeezed between other extant blocks of text. | ![howtouse-add](https://edition-assets.makingandknowing.org/webpages/howtouse-add.png)              |
| comment     | comment           | anchors for commentary by the editors                                                                                                                                                                                                                    | ![howtouse-asterisk](https://edition-assets.makingandknowing.org/webpages/howtouse-asterisk.png)    |
| corr        | correction        | denotes an editorial correction by the Making and Knowing Project team; renders in square brackets                                                                                                                                                       | ![howtouse-square](https://edition-assets.makingandknowing.org/webpages/howtouse-square.png)        |
| del         | deletion          | denotes a deletion by the writer in the original; renders in struck-through red font                                                                                                                                                                     | ![howtouse-del](https://edition-assets.makingandknowing.org/webpages/howtouse-del.png)              |
| emph        | emphasis          | denotes italic French script                                                                                                                                                                                                                             | ![howtouse-bold](https://edition-assets.makingandknowing.org/webpages/howtouse-bold.png)            |
| exp         | expansion         | denotes use of abbreviation suspensions                                                                                                                                                                                                                  | ![howtouse-curly](https://edition-assets.makingandknowing.org/webpages/howtouse-curly.png)          |
| figure      | figure            | a sketch, drawing, diagram, etc. present in the source Ms.                                                                                                                                                                                               |                                                                                                                        |
| gap         | gap               | gap within the written text                                                                                                                                                                                                                              | ![howtouse-gap](https://edition-assets.makingandknowing.org/webpages/howtouse-gap.png)              |
| hr          | horizontal rule   | a horizontal line in the text                                                                                                                                                                                                                            | ![howtouse-hr](https://edition-assets.makingandknowing.org/webpages/howtouse-hr.png)                |
| ill         | illegible         | illegible                                                                                                                                                                                                                                                |  ![howtouse-illegible](https://edition-assets.makingandknowing.org/webpages/howtouse-illegible.png) |
| mark        | mark              | a mark in the text that has a corresponding unicode character                                                                                                                                                                                            |                                                                                                                        |
| sup         | supplied text     | editorial intervention by the Making and Knowing Project, supplying headers for a small subset of entries (mostly lists) that do not have distinct headers in the original for clarity in computational analysis of the text                                                                                                               | rendered only in [List of Entries](/entries)(not in folios)         |
...
| ups         | under paper strip | parts of the text that were covered by the paper strips placed around each page of the manuscript during its seventeenth-century re-binding in the Bethune bindings                                                                                      | ![howtouse-ups](https://edition-assets.makingandknowing.org/webpages/howtouse-ups.png)              |
...
| Tag | Definition |                                                               Description and Use                                                               | Rendering (when applicable)                                                                                       |
|-----|------------|-------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| de  | german     | denotes a word with a probable German origin                                                                                                    | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
| fr  | french     | denotes a word left in French in the English translation because meaning is unclear or a translation does not exist, renders as italicized text | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
| el  | greek      | a word or phrase in Greek (in Greek or Latin script)                                                                                            | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
| it  | italian    | text in Italian                                                                                                                                 | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
| la  | latin      | text in Latin                                                                                                                                   | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
| oc  | occitan    | word or phrase in the Occitan language or of an Occitan root                                                                                    | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
| po  | poitevin   | word in the Poitevin dialect                                                                                                                    | ![howtouse-italics](https://edition-assets.makingandknowing.org/webpages/howtouse-italics.png) |
...
## Linguistic Resources: Dictionaries and Technical Encyclopedias
