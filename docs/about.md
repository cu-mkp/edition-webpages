...
The digital facsimile images of Ms. Fr. 640 are provided by the BnF’s digital library, [Gallica](https://gallica.bnf.fr/ark:/12148/btv1b10500001g). They are integrated into the Edition through its IIIF Manifest, which relates the Project's transcription and translation of the manuscript to the corresponding Gallica folio images via the IIIF Presentation API. Because the facsimile images of the manuscript pages are being pulled directly from Gallica, any outage of Gallica will affect the rendering of the facsimile images (and may affect the rendering of the transcription and translation) on the Edition site.
...
DOI: https://doi.org/10.7916/78yt-2v41
